...
class TermsAndConditionsDialog extends StatelessWidget {
  void _onAgreeButtonPressed(BuildContext context) {
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Text('プライバシーポリシー'),
            Text(
                'office ナンジャモ・ンジャ（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。'),
            Text('第1条（個人情報）'),
            Text(
            ...
            Text('当社サービスの提供・運営のため'),
            Text('ユーザーからのお問い合わせに回答するため（本人確認を行うことを含む）'),
            Text('利用規約'),
            Text(
                'この利用規約（以下，「本規約」といいます。）は，office ナンジャモ・ンジャ（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。'),
            Text('第1条（適用）'),
            ...
            Text('第9条（利用規約の変更）'),
            Text('1.	当社は以下の場合には、ユーザーの個別の同意を要せず、本規約を変更することができるものとします。'),
            Text('・	本規約の変更がユーザーの一般の利益に適合するとき。'),
            Text(
